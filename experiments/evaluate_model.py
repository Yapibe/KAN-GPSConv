...
def main(args):
    ...
    if args.task == 'node':
        ...
        _, _, test_loader = prepare_graph_data(dataset, batch_size=args.batch_size, num_workers=args.num_workers, sample_sizes=args.sample_sizes)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Evaluate KAN-GPS Network on node or graph classification datasets')
